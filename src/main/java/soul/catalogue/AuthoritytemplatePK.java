 ...
 */
@Embeddable
public class AuthoritytemplatePK implements Serializable {
    ...
    public AuthoritytemplatePK() {
    }

    public AuthoritytemplatePK(String templateID, String sRNo, String tag, String subfield) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AuthoritytemplatePK)) {
            return false;
        }
        AuthoritytemplatePK other = (AuthoritytemplatePK) object;
    ...
    public String toString() {
        return "soul.catalogue.AuthoritytemplatePK[ templateID=" + templateID + ", sRNo=" + sRNo + ", tag=" + tag + ", subfield=" + subfield + " ]";
    }
