 ...
 */
@Embeddable
public class AuthoritybiblidetailsPK implements Serializable {
    ...
    public AuthoritybiblidetailsPK() {
    }

    public AuthoritybiblidetailsPK(int recID, int tagSrNo, String tag, int sbFldSrNo, String sbFld) {
        this.recID = recID;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AuthoritybiblidetailsPK)) {
            return false;
        }
        AuthoritybiblidetailsPK other = (AuthoritybiblidetailsPK) object;
    ...
    public String toString() {
        return "soul.catalogue.AuthoritybiblidetailsPK[ recID=" + recID + ", tagSrNo=" + tagSrNo + ", tag=" + tag + ", sbFldSrNo=" + sbFldSrNo + ", sbFld=" + sbFld + " ]";
    }
