 ...
 */
@Embeddable
public class CtgryMediaIssueReservePK implements Serializable {
    ...
    public CtgryMediaIssueReservePK() {
    }

    public CtgryMediaIssueReservePK(String ctgryCd, String mediaCd) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CtgryMediaIssueReservePK)) {
            return false;
        }
        CtgryMediaIssueReservePK other = (CtgryMediaIssueReservePK) object;
    ...
    public String toString() {
        return "soul.circulation.CtgryMediaIssueReservePK[ ctgryCd=" + ctgryCd + ", mediaCd=" + mediaCd + " ]";
    }
